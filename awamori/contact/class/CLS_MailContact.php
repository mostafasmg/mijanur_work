...
{
    CONST TOADDRESS = "shikina.interarts@gmail.com";  // メールの送信先
//     CONST TOADDRESS = "akikazu_karino@imprest.co.jp";  // テストメールの送信先
    /********************************************************************/
    /* public Method                                                    */
    /********************************************************************/
    // コンストラクタ
    public function __construct($dir_offset)
    {
        ...
        // メールの題名
        $this->mailSubject = "【琉球びんがた泡盛ストリート】お問い合わせがございました。";
