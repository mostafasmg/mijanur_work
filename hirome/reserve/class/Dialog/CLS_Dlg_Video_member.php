...
require_once(dirname(__FILE__) . "/../Db/CLS_Db_TblMemberfile.php");

//ダイアログクラス(VIDEO)
class CLS_Dlg_Video_member extends CLS_Page_Ex
{
    public function index()
    {
        ...
        // 動画情報取得
        $objTblMemberFile = new CLS_Db_TblMemberfile($conn);
        $table = $objTblMemberFile->GetTableDetailsById($file_id);
