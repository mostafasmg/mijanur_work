...
class CLS_Online_Ex extends CLS_Page_Ex
{
    ...
    {
        // 出力テンプレートの取得
        $temp_category = file_get_contents(dirname(__FILE__) . "/../../template/tpl/tags/custmenu_category.tpl");
        $temp_group = file_get_contents(dirname(__FILE__) . "/../../template/tpl/tags/custmenu_group.tpl");
        $temp_function = file_get_contents(dirname(__FILE__) . "/../../template/tpl/tags/custmenu_function.tpl");
...
// 2018.05.01 S:Add
                    $themecolor = $table[$j]["themecolor"];
                    $style_bgcolor = "background-color:{$themecolor};";
                    $work_function = str_replace("++[sys_themecolor]", $style_bgcolor, $work_function);
// 2018.05.01 E:Add
